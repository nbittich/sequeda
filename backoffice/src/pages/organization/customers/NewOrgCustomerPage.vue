...
import { Communication, Organization, OrgCustomer, Remark, representedByIsOrg } from 'src/models/orgs';
...
export default defineComponent({
  ...
  async setup() {
    ...
    return { communications, representedByPerson, representedByOrg, pictureFile, customerType, positionId, started, ended };
  },
  methods: {
    async update() {
