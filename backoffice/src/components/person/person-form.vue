...
<template>
  <q-card-section v-if="title?.length">
    <div class="text-h6">{{ title }}</div>
  </q-card-section>
  <q-card-section class="row justify-center">
    <div class="col">
      <div class="text-h6 q-ml-xs-sm">Picture Profile</div>
      <ImageUpload :key="imageKey" v-model="profilePictureFile" :picture-id="person.profilePictureId" />
    </div>
    <template v-if="withSignature">
      <div class="col">
        <div class="text-h6 q-ml-xs-sm">Signature</div>

        <ImageUpload :key="imageKey" v-model="signatureFile" :picture-id="person.signatureId" />
      </div>
    </template>
  </q-card-section>
  <q-separator />
  ...
  <q-card-section class="q-mb-none q-pb-none">
    <div class="row q-mb-xs-none q-mb-md-xs">
      <div class="col-lg-6 col-12 q-mb-xs-sm q-mb-lg-none">
        <q-input :autofocus="true" class="q-mr-sm-xs" dense outlined v-model="person.firstName" label="First name" />
      </div>
      <div class="col-lg-6 col-12 q-mb-xs-sm q-mb-lg-none">
        <q-input class="q-mr-md-xs" dense outlined v-model="person.lastName" label="Last name" />
      </div>
    </div>
    <div class="row q-mb-xs-none q-mb-md-xs">
      <div class="col-lg-6 col-12 q-mb-xs-sm q-mb-lg-none">
        <q-input class="q-mr-md-xs" dense outlined v-model="person.nickName" label="Nick name" />
      </div>
      <div class="col-lg-6 col-12 q-mb-xs-sm q-mb-lg-none">
        <q-input dense class="q-mr-md-xs" outlined v-model="person.middleName" label="Middle name" />
      </div>
    </div>

    <div class="row q-mb-xs-none q-mb-md-xs">
      <div class="col-lg-6 col-12">
        <q-input dense outlined class="q-mr-md-xs" label="Birth date" v-model="person.dateOfBirth" :rules="['date']">
      ...
      <div class="col-lg-6 col-12 q-mb-xs-sm q-mb-lg-none">
        <q-select dense class="q-mr-md-xs" outlined v-model="person.gender" :options="genders" option-label="label"
          option-value="value" emit-value map-options label="Gender" />
      </div>
    </div>
  </q-card-section>
  ...
  <q-card-section class="q-mt-xs-sm q-mt-md-none q-pt-none">
    <div class="row q-mb-xs-none q-mb-md-xs">
      <div class="col-lg-6 col-12 q-mb-xs-sm q-mb-lg-none">
        <q-select class="q-mr-md-xs" dense outlined v-model="person.maritalStatus" :options="maritalStatuses"
          label="Status" option-label="label" option-value="value" emit-value map-options />
      </div>
